...
Коммерческий опыт в E-commerce (ритейл). Участвовала в полном цикле внедрения PIM-системы (от сбора требований до UAT и миграции БД). Уверенная техническая база: сложные SQL-запросы, тестирование API, работа со снифферами и логами. Понимаю клиент-серверную архитектуру и специфику мобильной разработки.
